...
<br>
Пользуясь случаем, сообщаю, что мой патч, блокирующий аналогичные эксплойты, принят в Linux kernel mainline. Технические детали <a href="http://blog.ptsecurity.ru/2017/08/linux-block-double-free.html">опубликованы в нашем корпоративном блоге</a>.
