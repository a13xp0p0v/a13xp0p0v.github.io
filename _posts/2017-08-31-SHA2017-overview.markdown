...
I would like to note that the Linux kernel maintainers have accepted my patch which blocks similar exploits. More technical details are [available][3] at the Positive Technologies blog.
...
[3]: http://blog.ptsecurity.com/2017/08/linux-block-double-free.html
